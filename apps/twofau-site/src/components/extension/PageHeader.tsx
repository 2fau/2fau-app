          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  One source. Two browsers. No servers in between.
                </div>
              </div>
              <div
              ...
              >
                ...
                >
                  The same Rust core, compiled to WebAssembly and running in the tab you're already in.
                  Chrome, Edge and Firefox are built from one manifest, so a feature never lands on one
                  and quietly skips the other.
                </div>
              </div>
              <div
                data-pencil-name="Install Row"
                className="box-border w-full h-fit shrink-0 flex flex-row gap-[10px] p-[36px_0px_0px_0px] justify-start items-center"
              >
                <a href="https://chromewebstore.google.com/" target="_blank" rel="noreferrer noopener"
                  data-pencil-name="Btn Add to Chrome"
                ...
                <a href="https://microsoftedge.microsoft.com/addons" target="_blank" rel="noreferrer noopener"
                  data-pencil-name="Btn Edge"
                ...
                <a href="https://addons.mozilla.org/firefox/" target="_blank" rel="noreferrer noopener"
                  data-pencil-name="Btn Firefox"
                  className="box-border w-fit shrink-0 h-fit flex flex-row gap-[9px] p-[13px_20px] justify-start items-center bg-[#1B1B1E] [outline:1px_solid_#38383A] [outline-offset:-0.5px] rounded-[8px] no-underline"
                >
                  <div
                    data-pencil-name="Logo"
              ...
              <div
                data-pencil-name="Browser Chips"
                className="box-border w-full h-fit shrink-0 flex flex-row gap-[10px] p-[26px_0px_0px_0px] justify-start items-center"
              >
                <div
                  data-pencil-name="Chip Chrome"
                  className="box-border w-fit shrink-0 h-fit flex flex-row gap-[9px] p-[8px_14px] justify-start items-center bg-[#1B1B1E] [outline:1px_solid_#262628] [outline-offset:-0.5px] rounded-[100px]"
                >
                  <div
                    data-pencil-name="Logo"
                    className="box-border w-[15px] shrink-0 h-[15px] overflow-hidden relative"
                  >
                    <svg
                      viewBox="1.1920928955078125e-7 0 15.516000628471375 10.51200008392334"
                      preserveAspectRatio="none"
                  ...
                  <div
                    ...
                    className="text-[13.5px]/[normal] box-border text-[#F5F5F7] font-[Inter,system-ui,sans-serif] font-medium text-left [white-space:nowrap]"
                  >
                    Chrome
                  </div>
                  <div
                    data-pencil-name="Ver"
